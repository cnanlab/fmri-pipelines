...
roi_extract_all_node = Node(Function(input_names=['input_nifti', 'mask_file_path'], output_names=["roi_dicts"], function=utils.roi_extract_all_node_func), name="roi_extract_all", overwrite=roi_extract_overwrite)
